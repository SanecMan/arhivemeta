...
/datum/action/cooldown/spell
	...
	var/list/resource_costs // MASSMETA EDIT ADDITION (vampires)
	/// Boolean, if true, resource costs will be ignored
	var/bypass_cost = FALSE // MASSMETA EDIT ADDITION (vampires)
...
/datum/action/cooldown/spell/Activate(atom/cast_on)
	...
	if(!(precast_result & SPELL_NO_IMMEDIATE_COOLDOWN))
		...
		StartCooldown()
		consume_resource() // MASSMETA EDIT ADDITION (vampires)
