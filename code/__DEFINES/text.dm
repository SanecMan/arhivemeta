...
#define BRAIN_DAMAGE_FILE "massmeta/traumas_ru.json" //MASSMETA EDIT CHANGE (hallucinations_ru) - ORIGINAL: "traumas.json"
...
#define HALLUCINATION_FILE "massmeta/hallucination_ru.json" //MASSMETA EDIT CHANGE (hallucinations_ru) - ORIGINAL: "hallucination.json"
