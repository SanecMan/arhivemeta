...
/datum/preference/choiced/vulpkanin_body_markings/icon_for(value)
	...
	if (isnull(body))
		...
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_chest_m"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_l_leg"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_r_leg"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_l_arm"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_r_arm"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_l_hand"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_r_hand"), ICON_OVERLAY)
...
/datum/preference/choiced/vulpkanin_head_markings/icon_for(value)
	...
	if (isnull(body))
		body = icon('icons/blanks/32x32.dmi', "nothing")
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_head_m"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_chest_m"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_l_leg"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_r_leg"), ICON_OVERLAY)
		body.Blend(icon('massmeta/icons/vulps/body.dmi', "vulpkanin_l_arm"), ICON_OVERLAY)
...
/datum/preference/choiced/vulpkanin_facial_hair/icon_for(value)
	...
	if (isnull(head_icon))
		head_icon = icon('massmeta/icons/vulps/body.dmi', "vulpkanin_head_m")
