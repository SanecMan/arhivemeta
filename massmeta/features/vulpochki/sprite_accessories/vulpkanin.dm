...
/datum/sprite_accessory/vulpkanin_body_markings
	icon = 'massmeta/icons/vulps/body_markings.dmi'
	name = "None"
	icon_state = "none"
...
/datum/sprite_accessory/tails/vulpkanin
	icon = 'massmeta/icons/vulps/body_accessory.dmi'
	spine_key = "vulpkanin"
...
/datum/sprite_accessory/vulpkanin_head_accessories
	icon = 'massmeta/icons/vulps/facial_hair.dmi'
	name = "None"
	icon_state = "none"
...
/datum/sprite_accessory/vulpkanin_head_accessories/vulp_nose
	icon = 'massmeta/icons/vulps/head_markings.dmi'
	name = "Vulpkanin Nose"
	icon_state = "nose"
...
/datum/sprite_accessory/vulpkanin_tail_markings
	icon = 'massmeta/icons/vulps/tail_markings.dmi'
	name = "None"
	icon_state = "none"
	em_block = TRUE
